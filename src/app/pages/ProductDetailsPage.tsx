...
export const ProductDetailsPage = () => {
    ...
    const { data: reviewData, isLoading: isReviewLoading, isError } = useGetProductReviewsQuery(productId)
    ...
    else if (!reviewData || isError) averageReviewContent = <Typography variant="caption" color="textDisabled">No Reviews yet</Typography>
